...
namespace GradeBook.Tests
{
    public class SchoolTests
    {
        ...
        public SchoolTests()
        {
            ...
            this.school.AddCourse(new Course() { Name = "Cooking", InstanceYear = 2021, Semester = 2, LectureCount = 30, PracticeCount = 100, TeacherName = "Nanny Ogg" });
            this.school.AddCourse(new Course(){Name ="Policemanship", InstanceYear = 2021, Semester = 1, LectureCount = 30, PracticeCount = 100, TeacherName = "Lord Vetinari" });
            this.school.AddCourse(new Course() { Name = "Thieving", InstanceYear = 2021, Semester = 3, LectureCount = 30, PracticeCount = 100, TeacherName = "Urdo van Pew" });
            this.school.AddCourse(new Course() { Name = "Fighting", InstanceYear = 2021, Semester = 1, LectureCount = 30, PracticeCount = 100, TeacherName = "Sam Vimes" });
        }
